...
class ConfigurationManager:
    ...
    def __init__(self):
        ...
        self.web_scraping = WebScrapingConfig(
            ...
            max_content_size=int(os.getenv("SCRAPING_MAX_CONTENT_SIZE", str(50 * 1024 * 1024))),
            ...
            respect_robots_txt=os.getenv("SCRAPING_RESPECT_ROBOTS", "true").lower() == "true",
            enable_ssrf_protection=os.getenv("SCRAPING_ENABLE_SSRF_PROTECTION", "true").lower() == "true",
