...
class TokenExpiredError(AuthenticationError):
    ...
    def __init__(self, message: str = "Token has expired", error_code: str = "TOKEN_EXPIRED"):
        super().__init__(message, error_code)
...
class InsufficientPermissionsError(AuthorizationError):
    ...
    def __init__(self, message: str = "Insufficient permissions", error_code: str = "INSUFFICIENT_PERMISSIONS"):
        super().__init__(message, error_code)
...
class OrganizationAccessError(AuthorizationError):
    ...
    def __init__(self, message: str = "Organization access denied", error_code: str = "ORG_ACCESS_DENIED"):
        super().__init__(message, error_code)
...
class RoleRequiredError(AuthorizationError):
    ...
    def __init__(self, message: str = "Required role not found", error_code: str = "ROLE_REQUIRED"):
        super().__init__(message, error_code)
...
class UserCreationError(AuthenticationError):
    ...
    def __init__(self, message: str = "Failed to create user", error_code: str = "USER_CREATION_FAILED"):
        super().__init__(message, error_code)
...
class OrganizationCreationError(AuthenticationError):
    ...
    def __init__(self, message: str = "Failed to create organization", error_code: str = "ORG_CREATION_FAILED"):
        super().__init__(message, error_code)
...
class ConfigurationError(AuthBaseException):
    ...
    def __init__(self, message: str = "Authentication configuration error", error_code: str = "CONFIG_ERROR"):
        super().__init__(message, error_code)
