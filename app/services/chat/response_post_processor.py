    ...
    def _remove_forbidden_phrases(
        ...
        if any(
            ...
            if base_location:
                ...
                response = "Right now I only have confirmed details about our other location, and nothing about additional offices yet. "
            response += (
                "However, all interactions and consultations can be managed online, and our team can assist you regardless "
                "of your location.\n\n"
            )
            if demo_links:
                response += (
